...
begin
  ...
  begin
    ...
    begin
      ...
      Add('delete from pedido_itens where id = '+idItem.ToString);
    end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Add('data=:data,idCliente=:idCliente,vlrTotal=:vlrTotal');
        Add('where id=:id');
        ...
        begin
          ...
          begin
            ...
            Add('idPedido=:idPedido, idProduto=:idProduto,Qtde=:Qtde,vlrUnitario=:vlrUnitario');
            Add('where id =:id');
