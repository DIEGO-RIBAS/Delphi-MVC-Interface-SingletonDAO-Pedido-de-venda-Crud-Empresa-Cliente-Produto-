...
type
  ...
  private
    ...
    procedure limpar;
    procedure CarregadadosCliente(idCliente : integer);
  public
    { Public declarations }
  end;
...
begin
  ...
  CarregadadosCliente(mClientesid.AsInteger);
end;
...
procedure TfrmClientes.CarregadadosCliente(idCliente : integer);
var
...
begin
  ...
  with LCliente do
  begin
    edtCodCliente.Text := id.ToString;
    edtNome.Text       := Nome;
